...
const appCss = "/assets/styles-BvypPkLm.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Multi-agent AI debate system that verifies claims and surfaces verdicts with sources."
      },
    ...
    links: [
      ...
      { rel: "icon", type: "image/svg+xml", href: "/shocheton.svg" },
...
const $$splitComponentImporter = () => import("./index-xBMlwskx.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Submit a claim or a PDF. Our AI agents will process it through a multi‑agent pipeline; a moderator will return a verdict with a trust score & sources."
    }, {
      property: "og:title",
      content: "Shocheton — AI Fact Checker"
    }, {
      property: "og:description",
      content: "Submit a claim or a PDF. Our AI agents will process it through a multi‑agent pipeline; a moderator will return a verdict with a trust score & sources."
    }]
